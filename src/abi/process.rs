...
#[cfg(test)]
mod tests {
    use super::is_valid_process_signal;
    use super::ProcessSignalRecord;
    use super::ProcessSpawnOptions;
    use super::ProcessSpawnStringRef;
    use super::ProcessTerminationRecord;
    use super::PROCESS_SIGNAL_FLAG_NONE;
    use super::PROCESS_SIGNAL_KNOWN_FLAGS;
    use super::PROCESS_SIGNAL_MAX;
    use super::PROCESS_SIGNAL_MIN;
    use super::PROCESS_SIGNAL_RECORD_PAYLOAD_OFFSET;
    use super::PROCESS_SIGNAL_RECORD_SENDER_PID_OFFSET;
    use super::PROCESS_SIGNAL_RECORD_SIGNAL_OFFSET;
    use super::PROCESS_SIGNAL_RECORD_SIZE;
    use super::PROCESS_SPAWN_FLAG_INHERIT_STDERR;
    use super::PROCESS_SPAWN_FLAG_INHERIT_STDIN;
    use super::PROCESS_SPAWN_FLAG_INHERIT_STDIO;
    use super::PROCESS_SPAWN_FLAG_INHERIT_STDOUT;
    use super::PROCESS_SPAWN_FLAG_INHERIT_WORKING_DIR;
    use super::PROCESS_SPAWN_FLAG_OVERRIDE_ARGUMENTS;
    use super::PROCESS_SPAWN_FLAG_OVERRIDE_ENVIRONMENT;
    use super::PROCESS_SPAWN_FLAG_OVERRIDE_WORKING_DIR;
    use super::PROCESS_SPAWN_OPTIONS_ARGC_OFFSET;
    use super::PROCESS_SPAWN_OPTIONS_ARGV_OFFSET;
    use super::PROCESS_SPAWN_OPTIONS_ENVC_OFFSET;
    use super::PROCESS_SPAWN_OPTIONS_ENV_OFFSET;
    use super::PROCESS_SPAWN_OPTIONS_FLAGS_OFFSET;
    use super::PROCESS_SPAWN_OPTIONS_SIZE;
    use super::PROCESS_SPAWN_OPTIONS_WORKING_DIR_LEN_OFFSET;
    use super::PROCESS_SPAWN_OPTIONS_WORKING_DIR_OFFSET;
    use super::PROCESS_SPAWN_STRING_REF_LEN_OFFSET;
    use super::PROCESS_SPAWN_STRING_REF_PTR_OFFSET;
    use super::PROCESS_SPAWN_STRING_REF_SIZE;
    use super::PROCESS_TERMINATION_KIND_EXCEPTION;
    use super::PROCESS_TERMINATION_KIND_EXIT;
    use super::PROCESS_TERMINATION_KIND_NONE;
    use super::PROCESS_TERMINATION_RECORD_ERROR_CODE_OFFSET;
    use super::PROCESS_TERMINATION_RECORD_FAULT_ADDRESS_OFFSET;
    use super::PROCESS_TERMINATION_RECORD_FAULT_ADDRESS_PRESENT_OFFSET;
    use super::PROCESS_TERMINATION_RECORD_KIND_OFFSET;
    use super::PROCESS_TERMINATION_RECORD_SIZE;
    use super::PROCESS_TERMINATION_RECORD_STATUS_OFFSET;
    use super::PROCESS_TERMINATION_RECORD_VECTOR_OFFSET;
    use super::WAIT_PROCESS_BLOCK_INDEFINITELY_TICKS;
    use super::WAIT_SIGNAL_BLOCK_INDEFINITELY_TICKS;
    use core::mem::offset_of;
