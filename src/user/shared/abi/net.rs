...
#[cfg(test)]
mod tests {
    use super::NetworkBackendClass;
    use super::NetworkStatus;
    use super::NETWORK_CONNECT_FLAG_NONE;
    use super::NETWORK_CONNECT_KNOWN_FLAGS;
    use super::NETWORK_STATUS_FLAG_AVAILABLE;
    use super::NETWORK_STATUS_FLAG_IPV6;
    use super::NETWORK_STATUS_FLAG_READ_TIMEOUTS;
    use super::NETWORK_STATUS_FLAG_REQUIRES_HOST_RUNTIME;
    use super::NETWORK_STATUS_FLAG_STREAM_IO;
    use super::NETWORK_STATUS_FLAG_TCP_CONNECT;
    use super::NETWORK_STATUS_FLAG_TCP_LISTEN;
    use super::NETWORK_STATUS_FLAG_UDP_DATAGRAM;
    use super::NETWORK_STATUS_FLAG_ZERO_TIMEOUT_READ_IS_POLL;
