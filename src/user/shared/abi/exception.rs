...
#[cfg(test)]
mod tests {
    use super::AArch64AbortSyndrome;
    use super::AArch64UserExceptionFrame;
    use super::X86_64GeneralProtectionError;
    use super::X86_64InvalidTssError;
    use super::X86_64PageFaultError;
    use super::X86_64SegmentNotPresentError;
    use super::X86_64StackSegmentError;
    use super::X86_64UserExceptionFrame;
    use super::AARCH64_ABORT_ACCESS_KIND_EXECUTE;
    use super::AARCH64_ABORT_ACCESS_KIND_WRITE;
    use super::AARCH64_EXCEPTION_DATA_ABORT_VECTOR;
    use super::AARCH64_EXCEPTION_INSTRUCTION_ABORT_VECTOR;
    use super::AARCH64_USER_EXCEPTION_FRAME_ERROR_CODE_OFFSET;
    use super::AARCH64_USER_EXCEPTION_FRAME_FAULT_ADDRESS_OFFSET;
    use super::AARCH64_USER_EXCEPTION_FRAME_INSTRUCTION_POINTER_OFFSET;
    use super::AARCH64_USER_EXCEPTION_FRAME_SAVED_PROGRAM_STATUS_OFFSET;
    use super::AARCH64_USER_EXCEPTION_FRAME_SIZE;
    use super::AARCH64_USER_EXCEPTION_FRAME_STACK_POINTER_OFFSET;
    use super::AARCH64_USER_EXCEPTION_FRAME_VECTOR_OFFSET;
    use super::AARCH64_USER_EXCEPTION_FRAME_X0_OFFSET;
    use super::AARCH64_USER_EXCEPTION_FRAME_X30_OFFSET;
    use super::X86_64_EXCEPTION_DEVICE_NOT_AVAILABLE_VECTOR;
    use super::X86_64_EXCEPTION_DOUBLE_FAULT_VECTOR;
    use super::X86_64_EXCEPTION_GENERAL_PROTECTION_VECTOR;
    use super::X86_64_EXCEPTION_INVALID_OPCODE_VECTOR;
    use super::X86_64_EXCEPTION_INVALID_TSS_VECTOR;
    use super::X86_64_EXCEPTION_PAGE_FAULT_VECTOR;
    use super::X86_64_EXCEPTION_SEGMENT_NOT_PRESENT_VECTOR;
    use super::X86_64_EXCEPTION_STACK_SEGMENT_VECTOR;
    use super::X86_64_USER_EXCEPTION_FRAME_ERROR_CODE_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_FAULT_ADDRESS_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_R10_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_R11_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_R12_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_R13_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_R14_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_R15_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_R8_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_R9_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_RAX_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_RBP_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_RBX_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_RCX_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_RDI_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_RDX_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_RFLAGS_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_RIP_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_RSI_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_RSP_OFFSET;
    use super::X86_64_USER_EXCEPTION_FRAME_SIZE;
    use super::X86_64_USER_EXCEPTION_FRAME_VECTOR_OFFSET;
    use core::mem::offset_of;
    use core::mem::size_of;
